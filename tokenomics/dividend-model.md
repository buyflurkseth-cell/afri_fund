...
* Quarterly profit distributions to all AFR holders
* Pro-rata share based on token holdings
* **Estimated annual yield: 15–25%** (based on historical infrastructure returns in East Africa)
* Payments executed automatically via smart contract, paid in SOL

![Dividend Model](../AfriFUND_INV_05_DividendModel.png)
